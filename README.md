Para ejecutar la aplicacion se debe ir a la clase principal del proyecto, y desde ahi se inicia el servicio API REST, dando click sobre el boton iniciar en la parte superior del IDE
